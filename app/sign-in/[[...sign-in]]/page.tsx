  ...
  return (
    <>
      ...
      <main style={{ minHeight: "100vh", background: "#08090d", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", padding: "20px" }}>
        {/* Mesh gradients */}
        <div className="mesh-anim" style={{ position: "absolute", top: -160, left: -160, width: 500, height: 500, borderRadius: "50%", opacity: 0.3, background: "radial-gradient(circle, rgba(167,139,250,0.4) 0%, rgba(167,139,250,0) 70%)", filter: "blur(80px)", pointerEvents: "none" }} />
        <div className="mesh-anim" style={{ position: "absolute", bottom: -160, right: -160, width: 400, height: 400, borderRadius: "50%", opacity: 0.25, background: "radial-gradient(circle, rgba(244,114,182,0.4) 0%, rgba(244,114,182,0) 70%)", filter: "blur(80px)", pointerEvents: "none", animationDelay: "8s" }} />
        ...
        <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", gap: 32 }}>
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 32, fontWeight: 600, color: "white", letterSpacing: "-0.025em", lineHeight: 1.1, marginBottom: 8 }}>
              Welcome <em style={{ fontFamily: "Instrument Serif, serif", fontStyle: "italic", background: "linear-gradient(135deg, #a78bfa 0%, #f472b6 50%, #fb923c 100%)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" }}>back.</em>
            </div>
            <div style={{ fontSize: 14, color: "rgba(255,255,255,0.5)", fontWeight: 300 }}>Sign in to continue your POD research.</div>
          </div>
