  ...
  return (
    <main className="min-h-screen bg-[#0a0812] text-white">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 pb-24">
              ...
              <Link href="/sign-up"
                className={`block text-center py-3 rounded-xl font-semibold text-sm transition-all ${
                  plan.highlight
                    ...
                    : "bg-white/5 hover:bg-purple-600/20 text-white border border-purple-500/20"
                }`}>
                {plan.cta}
              </Link>
            </div>
        ...
        <div className="mt-12 bg-purple-500/5 border border-purple-500/20 rounded-2xl p-6 text-center">
          <p className="text-white font-semibold mb-1">🎯 Not sure which plan?</p>
          <p className="text-purple-300/50 text-sm">Start with the 1-day free trial — no card needed. Upgrade anytime.</p>
        </div>
